...
add_persian(
    ...
    "سایت با Next.js 16، TypeScript، Prisma (SQLite) و your-ai-provider برای چت هوش مصنوعی ساخته شده است. "
...
features = [
    ...
    "چت هوش مصنوعی با پشتیبانی از چند ارائه‌دهنده (OpenAI، Anthropic، ، Ollama)",
...
providers = [
    ("Custom Provider", "استفاده از your-ai-provider، بدون نیاز به API key"),
